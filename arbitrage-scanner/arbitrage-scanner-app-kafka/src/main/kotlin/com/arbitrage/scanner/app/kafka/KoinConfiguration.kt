...
import com.arbitrage.scanner.app.kafka.config.KafkaConfigLoader
import com.arbitrage.scanner.app.kafka.factories.KafkaConsumerFactory
import com.arbitrage.scanner.app.kafka.factories.KafkaProducerFactory
...
val kafkaConfigModule: Module = module {
    single<KafkaConfig> { KafkaConfigLoader.load() }
}
